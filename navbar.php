...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="mx-2 text-white">Students</div>

				<a href="index.php?page=students" class="nav-item nav-students"><span class='icon-field'><i class="fa fa-user "></i></span> Students</a>
				<a href="index.php?page=courses" class="nav-item nav-courses"><span class='icon-field'><i class="fa fa-scroll "></i></span> Programs & Fees</a>
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-user "></i></span> Users</a>
