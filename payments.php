		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					...
					<i class="fa"style="font-size:15px;color:green">&#xf0d6;</i> Collect Fee 
				</a></span>
					</div>
					<div class="card-body">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<p> <b><?php echo $row['feetype'] ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-outline-success view_payment" type="button" data-id="<?php echo $row['id'] ?>" data-ef_id="<?php echo $row['ef_id'] ?>"><i class="fa fa-eye"></i></button>
										<button class="btn btn-sm btn-outline-primary edit_payment" type="button" data-id="<?php echo $row['id'] ?>" ><i class="fa fa-edit"></i></button>
										<button class="btn btn-sm btn-outline-danger delete_payment" type="button" data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash"></i></button>
									</td>
								</tr>
								<?php 
									endwhile; 
